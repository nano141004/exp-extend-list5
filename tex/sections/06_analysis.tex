...
The aligned-cache score-balanced top-100 results are available for all five datasets.
Score-balanced grouping is below sequential top-100 on NFCorpus, SciFact, ArguAna, and SCIDOCS, and nearly tied with sequential top-100 on FiQA-2018.
Overall, the current results do not show a clear quality advantage for score-balanced grouping.
